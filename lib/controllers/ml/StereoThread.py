...
class StereoThread(QThread):
    ...
    def __init__(self):
        ...
        self.logger = logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s', filename='StereoThread.log', filemode='w')
                ...
                while True:
                    ...
                    if inDisparity is not None:
                        ...
                        with np.errstate(divide='ignore', invalid='ignore'):
                            depth_calculated = (focal_length * self.baseline) / (frameDisparity)
